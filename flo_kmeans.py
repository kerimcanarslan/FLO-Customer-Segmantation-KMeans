...
df["tenure"] = (analysis_date-df["first_order_date"]).astype('timedelta64[D]')

df["NEW_average_online"] = df["customer_value_total_ever_online"] / df["order_num_total_ever_online"]
df["NEW_average_offline"] = df["customer_value_total_ever_offline"] / df["order_num_total_ever_offline"]


model_df = df[["NEW_average_online","NEW_average_offline","order_num_total_ever_online","order_num_total_ever_offline","customer_value_total_ever_offline","customer_value_total_ever_online","recency","tenure"]]
model_df.head()
...
plt.subplot(8, 1, 7)
check_skew(model_df,'NEW_average_online')
plt.subplot(8, 1, 8)
check_skew(model_df,'NEW_average_offline')
plt.tight_layout()
...
final_df = df[["master_id","order_num_total_ever_online","order_num_total_ever_offline","customer_value_total_ever_offline","customer_value_total_ever_online","recency","tenure","NEW_average_offline","NEW_average_online"]]
...
final_df.groupby("segment").agg({"order_num_total_ever_online":["mean", "median", "count"],
                                  ...
                                  "NEW_average_online": ["mean", "median", "count"],
                                  "NEW_average_offline": ["mean", "median", "count"]
                                  })
